...
################################################################################
### Head: Model / Remove / rgaps-black-nobuttons
##

mod_remove_rgaps_black_nobuttons () {

	util_error_echo "rm -rf ${HOME}/.themes/RGapsBlackNoButtons"
	rm -rf "${HOME}/.themes/RGapsBlackNoButtons"

}

##
### Tail: Model / Remove / rgaps-black-nobuttons
################################################################################
