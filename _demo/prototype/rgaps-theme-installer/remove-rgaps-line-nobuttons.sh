...
################################################################################
### Head: Model / Remove / rgaps-line-nobuttons
##

mod_remove_rgaps_line_nobuttons () {

	util_error_echo "rm -rf ${HOME}/.themes/RGapsLineNoButtons"
	rm -rf "${HOME}/.themes/RGapsLineNoButtons"

}

##
### Tail: Model / Remove / rgaps-line-nobuttons
################################################################################
