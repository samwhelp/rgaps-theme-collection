...
################################################################################
### Head: Model / Config / xfwm-theme / rgaps-black
##

mod_config_xfwm_theme_rgaps_black () {

	util_error_echo 'xfconf-query -c "xfwm4" -p "/general/theme" -s "RGapsBlack"'
	xfconf-query -c "xfwm4" -p "/general/theme" -s "RGapsBlack"

}

##
### Tail: Model / Config / xfwm-theme / rgaps-black
################################################################################
