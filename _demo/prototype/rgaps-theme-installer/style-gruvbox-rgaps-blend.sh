...
################################################################################
### Head: Model / Config / xfwm-theme / rgaps-blend
##

mod_config_xfwm_theme_rgaps_blend () {

	util_error_echo 'xfconf-query -c "xfwm4" -p "/general/theme" -s "RGapsBlend"'
	xfconf-query -c "xfwm4" -p "/general/theme" -s "RGapsBlend"

}

##
### Tail: Model / Config / xfwm-theme / rgaps-blend
################################################################################
